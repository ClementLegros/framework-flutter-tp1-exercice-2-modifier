...
class MyDurationCalculationPage extends StatefulWidget {
  const MyDurationCalculationPage({Key? key, required this.title})
      : super(key: key);

  final String title;

  @override
  State<MyDurationCalculationPage> createState() =>
      _MyDurationCalculationPageState();
}
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const Center(child: Text("Page non modifié")),
            Spacer(),
            const Center(
              child: Text("Date 1 : "),
            ),
